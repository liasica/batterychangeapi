...
// arModel is a active record design model for table combo_order operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of combo_order.
	Table = "combo_order"
	// Model is the model object of combo_order.
