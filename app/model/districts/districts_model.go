...
// arModel is a active record design model for table districts operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of districts.
	Table = "districts"
	// Model is the model object of districts.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table districts.
	Columns = struct {
		Id       string //
		ParentId string //
		AdCode   string //
