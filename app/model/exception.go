...
type ExceptionReportReq struct {
    ...
    BatteryType string   `validate:"required" v:"required" json:"batteryType" enums:"60,72"` // 电池型号: 60 / 72
    Discoverer  uint     `validate:"required" v:"required" json:"discoverer" enums:"1,2"`    // 发现人: 1门店 2骑手
...
type ExceptionListItem struct {
    ...
    BatteryType string      `json:"batteryType" enums:"60,72"` // 产品类型: 60/72
    Discoverer  uint        `json:"discoverer" enums:"1,2"`    // 发现人: 1门店 2骑手
