...
// arModel is a active record design model for table group operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of group.
	Table = "group"
	// Model is the model object of group.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table group.
	Columns = struct {
		Id             string //           
        Name           string // 名称      
        ProvinceId     string //           
