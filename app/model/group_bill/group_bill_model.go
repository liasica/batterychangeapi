...
// arModel is a active record design model for table group_bill operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of group_bill.
	Table = "group_bill"
	// Model is the model object of group_bill.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table group_bill.
	Columns = struct {
		Id  string //
	}{
		Id: "id",
