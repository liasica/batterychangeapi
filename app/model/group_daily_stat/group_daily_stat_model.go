...
// arModel is a active record design model for table group_daily_stat operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of group_daily_stat.
	Table = "group_daily_stat"
	// Model is the model object of group_daily_stat.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table group_daily_stat.
	Columns = struct {
		Id           string //                      
        GroupId      string // 团队ID               
