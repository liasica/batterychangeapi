...
// arModel is a active record design model for table group_settlement operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of group_settlement.
	Table = "group_settlement"
	// Model is the model object of group_settlement.
