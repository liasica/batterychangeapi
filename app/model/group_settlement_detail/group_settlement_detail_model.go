...
// arModel is a active record design model for table group_settlement_detail operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of group_settlement_detail.
	Table = "group_settlement_detail"
	// Model is the model object of group_settlement_detail.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table group_settlement_detail.
	Columns = struct {
		Id            string //                                            
