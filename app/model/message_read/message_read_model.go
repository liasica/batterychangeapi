...
// arModel is a active record design model for table message_read operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of message_read.
	Table = "message_read"
	// Model is the model object of message_read.
