...
// arModel is a active record design model for table packages_order operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of packages_order.
	Table = "packages_order"
	// Model is the model object of packages_order.
