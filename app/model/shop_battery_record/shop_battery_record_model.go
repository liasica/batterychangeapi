...
// arModel is a active record design model for table shop_battery_record operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of shop_battery_record.
	Table = "shop_battery_record"
	// Model is the model object of shop_battery_record.
