...
// arModel is a active record design model for table shop_manager operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of shop_manager.
	Table = "shop_manager"
	// Model is the model object of shop_manager.
