...
// arModel is a active record design model for table sys_permissions operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_permissions.
	Table = "sys_permissions"
	// Model is the model object of sys_permissions.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table sys_permissions.
	Columns = struct {
		Id        string //                              
