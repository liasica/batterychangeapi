...
// arModel is a active record design model for table sys_roles operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sys_roles.
	Table = "sys_roles"
	// Model is the model object of sys_roles.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table sys_roles.
	Columns = struct {
		Id           string //           
        Name         string // 角色名称  
