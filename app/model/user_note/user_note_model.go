...
// arModel is a active record design model for table user_note operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of user_note.
	Table = "user_note"
	// Model is the model object of user_note.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table user_note.
	Columns = struct {
		Id           string //             
        UserId       string // 用户ID      
